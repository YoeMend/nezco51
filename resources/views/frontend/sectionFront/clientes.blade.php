						...
						<div  class="col-12 col-md-6 my-2">
							<div class="row justify-content-around ">
								<div class="col-12 col-md-10 px-0">
									<video class="video" controls="" src="{{ asset('public/video/empresa/'.$videoClient->url) }}""></video>
								</div>
			...
			<div class="col-12 my-5">
				<div class="row justify-content-around align-items-center text-center">
					...
					<div data-scroll="toggle(.fromTopIn, .fromTopOut)" class="col ">
						<img class="img-fluid col-8" src="{{ asset('public/img/empresas/'.$logo->imagen) }}" alt="{{ $logo->nombre }}">
					</div>
					@endforeach
				</div>
			</div>
