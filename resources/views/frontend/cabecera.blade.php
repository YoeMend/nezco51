...
<div class="container-fluid bg-white cabcera">
		<div class="container">
			 <div class="row justify-content-between pt-4" style="border-bottom: solid 1px silver">
				<div class="logo-sec col-5 col-lg-2 col-md-3 my-2 py-3">

					<img src="{{ asset('public/images/LogoNezco.svg') }}" alt="">

				</div>
				<div class="col-12 col-lg-8 col-md-8 text-right c-black p-0 pt-md-5 mt-lg-5 ">
					<h1 class=" tit ">@yield ('tit-cabecera')</h1>
				</div>
