...
<div class="app-title">
    <div>
        <h1><i class="fa fa-dashboard"></i> Editar Tipo de Producto</h1>
    ...
    <div class="col-md-6">
      <div class="tile">
        <div class="tile-body">
            ...
            <form class="form-horizontal" role="form" action="{{ route('tipoproducto.update', $tipoproducto->id) }}" method="POST">
             {{ csrf_field() }}
             {{ method_field('PUT') }}
             <div class="form-group">
                <label class="control-label">Descripción</label>
                <input type="text" id="descripcion" name="descripcion" value="{{ $tipoproducto->descripcion }}" class="form-control" placeholder="Descripción" data-toggle="tooltip" data-placement="bottom" title="Descripción de la Categoría">
            </div>
            <div class="tile-body">
            ...
            <div class="tile-footer">
               <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Guardar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="{{ route('tipoproducto.index') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
