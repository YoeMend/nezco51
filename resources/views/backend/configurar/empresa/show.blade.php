...
<div class="app-title">
    <div>
        <h1><i class="fa fa-dashboard"></i> Ficha Empresa</h1>
        ...
        <div class="tile">
            ...
            <form class="row" role="form" enctype="multipart/form-data" action="{{ route('empresa.update', ($empresa->id)) }}" method="POST">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control" type="text" name="nombre" id="nombre" placeholder="Nombre" value="{{ $empresa->nombre }}" readonly="">
                </div>
                <div class="form-group col-md-10">
                    <label class="control-label">Descripción</label>
                    <textarea class="form-control" rows="6" name="descripcion" id="descripcion" placeholder="Descripción y/o Detalles" readonly="">{{ $empresa->descripcion }}</textarea>
                </div>
